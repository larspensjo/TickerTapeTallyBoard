...
pub use super::holding_period_return::{
    apply_annualisation, compute_modified_dietz, compute_modified_dietz_denominator,
    DisplayPercentKind,
};
pub use super::period_amounts::{compute_period_amounts, PeriodAmounts};
...
#[cfg(test)]
mod tests {
    use super::super::cash_flow::test_support::{date, split_tx};
    use super::*;
